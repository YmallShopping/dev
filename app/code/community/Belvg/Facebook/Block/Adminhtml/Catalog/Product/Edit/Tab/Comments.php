 ...
 */
class Belvg_Facebook_Block_Adminhtml_Catalog_Product_Edit_Tab_Comments
    ...
    implements Mage_Adminhtml_Block_Widget_Tab_Interface
{
    ...
    protected function _prepareCollection()
    {
        ...
        $collection = Mage::getModel('facebook/comments')->getCollection()
                ->distinct(TRUE)
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn('created_at', array(
                'header' => Mage::helper('customer')->__('Commented On'),
                'type' => 'datetime',
                'align' => 'center',
                'index' => 'created_at',
                'gmtoffset' => TRUE
    ...
    {
        return $this->getUrl('adminhtml/facebook/productcomments', array('_current' => TRUE));
    }

    public function getTabLabel()
    {
        return Mage::helper('facebook')->__('Facebook Comments');
    }
    ...
    public function canShowTab()
    {
        if ($this->_getProduct()->getId() &&
                ...
                $this->helper('facebook')->isActiveComments()) {
            return TRUE;
        }

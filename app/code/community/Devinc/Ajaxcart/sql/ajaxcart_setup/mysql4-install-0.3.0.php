...
$installer->setConfigData('ajaxcart/configuration/enabled_jump', 									0);

$installer->setConfigData('ajaxcart/loader_configuration/petal1',  									'#54ABB4');
$installer->setConfigData('ajaxcart/loader_configuration/petal2',  									'#96E5EE');
$installer->setConfigData('ajaxcart/loader_configuration/petal3',  									'#DEDEDE');
...
$installer->setConfigData('ajaxcart/dragdrop/enable_category_dragdrop',  							0);
...
$installer->setConfigData('ajaxcart/dragdrop/tooltip_cart_text',  									'BUY');
$installer->setConfigData('ajaxcart/dragdrop/tooltip_compare_text',  								'COMPARE');
$installer->setConfigData('ajaxcart/dragdrop/tooltip_wishlist_text',  								'WISH');

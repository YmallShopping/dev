<?php
class Devinc_Ajaxcart_Block_Product_List_Upsell extends Mage_Catalog_Block_Product_List_Upsell
{    
    protected function _construct()
    {
    	$this->_itemLimits['upsell'] = Mage::getStoreConfig('ajaxcart/popup_configuration/product_number');
        parent::_construct();
    }

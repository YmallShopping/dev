 ...
 */
class Devinc_Ajaxcart_Block_Checkout_Cart_Item_Renderer_Configurable extends Mage_Checkout_Block_Cart_Item_Renderer_Configurable
{
    ...
    {
    	$browserInfo = Mage::getModel('license/module')->getBrowserInfo();
